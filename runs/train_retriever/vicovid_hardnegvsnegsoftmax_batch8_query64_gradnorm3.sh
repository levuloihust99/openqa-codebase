...
python train_retriever.py \
    --train-data-size 700 \
    --data-path gs://openqa-dpr/data/retriever/vi-covid/INT \
    ...
    --shuffle True \
    --seed 123 \
    --checkpoint-path gs://openqa-dpr/retriever/checkpoints/vi-covid/vicovid_hardnegvsnegsoftmax_batch8_query64_gradnorm3 \
